...
public class ControlleurEtiquetage {
	...
	public boolean CommenceEtiquetage(int index, String type) 
	{
		...
		synchronized(lock2) 
		{
			//System.out.println("type: " + _type_courant_commence_etiquetage);
			//System.out.println("index: " + _index_courant_commence_etiquetage);
			if (type == _type_courant_commence_etiquetage && index == _index_courant_commence_etiquetage) 
			{	
				//System.out.println("1");
				//System.out.println("_nb " + _nb + " _na " + _na + "_wa " + _wa + "_wb " + _wb + " _t" + _t);
